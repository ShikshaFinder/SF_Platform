...
function terms() {
  return (
    <>
      ...
      admission form/visit the redirect url.The fees of the respective institute
      must comply with the limits set by the Government of India at the time of
      placing ads. Moreover, clients should ensure that all school details are
      accurately provided. By adhering to these guidelines, clients can maximize
      their chances of receiving the guaranteed number of filled admission forms
      through our marketing platform. Any content in the marketing materials
      that discourages or asks viewers not to fill out the admission form is
      strictly prohibited. Our aim is to generate genuine interest and encourage
      ...
      of forms may take additional time.We are open to discuss how we store and
      update view,by purchasing you trust our system and our process.The forms filled
      by the users are not our responsibilty that they will be paid cutomeers or
      not,we will provide you details which they have submitted. Our vision is to create a business
      that supports all parties involved in this process. We genuinely strive to
